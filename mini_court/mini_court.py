...
class MiniCourt():
    def __init__(self, frame):
        ...
        self.set_canvas_backround_box_position(frame)
        self.set_mini_court_position()
        self.set_court_drawing_keypoints()
        self.set_court_lines()

    def convert_meters_to_pixels(self, meters):
            return convert_meters_to_pix_dist(meters,
    ...
    def get_mini_court_corrdinates(self, 
                                   object_position, 
                                   closest_keypoint, 
        ...
        distance_from_keypoint_x_pixels, distance_from_keypoint_y_pixels = mesure_xy_distance(object_position, closest_keypoint)

         #convert pixel distance into meters
        distance_from_keypoint_x_meters = convert_pix_to_dist(distance_from_keypoint_x_pixels,
                                                               player_height_in_meters,
                                                               player_height_in_pixels
                                                               )
        distance_from_keypoint_y_meters = convert_pix_to_dist(distance_from_keypoint_y_pixels,
                                                               player_height_in_meters,
                                                               player_height_in_pixels
                                                               )
    ...
    def convert_bbox_to_mini_court_coordinates(self, player_boxes, ball_boxes, original_court_keypoints):
        player_hights = {
        ...
        for frame_num, player_bbox in enumerate(player_boxes):
            ...
            for player_id, bbox in player_bbox.items():
                ...
                mini_court_player_position = self.get_mini_court_corrdinates(foot_position,
                                                                             closest_keypoint,
                                                                             closest_keypoint_index,
                                                                             max_player_height_in_pixels,
                                                                             player_hights[player_id])
                ...
                if closest_player_id_to_ball == player_id:
                    ...
                    closest_keypoint = (original_court_keypoints[closest_keypoint_index*2],
                                        original_court_keypoints[closest_keypoint_index*2+1])
                    mini_court_player_position = self.get_mini_court_corrdinates(ball_position,
                                                                             closest_keypoint,
                                                                             closest_keypoint_index,
                                                                             max_player_height_in_pixels,
                                                                             player_hights[player_id])
